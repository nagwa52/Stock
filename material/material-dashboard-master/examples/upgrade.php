            ...
            <div class="col-md-8 ml-auto mr-auto" >
              ...
              <div class="card"  style="width:800px;margin-top:10px;  margin-left:745px;">
                <div class="card-header card-header-primary">
                  <h2  style="text-allign:center">الارشيف</h2>
...
$sql = "SELECT Tid AS Tid,Tdate AS Tdate ,Tname AS Tname,Tsalary AS Tsalary,Tdata AS Tdata,Tnotes AS Tnotes  FROM trash";
