      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end">
            ...
            <button type="submit" style="height:80px;width: 200px;" 
                  name="submit" value="Register" 
                   class="btn btn-primary pull-right" style="vertical-align: center">اضافه بيانات</button>
            ...
            <div class="col-md-8 ml-auto mr-auto">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h2  style="text-allign:center">الخزينه</h2>
...
$sql = "SELECT id AS id,date AS date ,name AS name,salary AS salary,data AS data,notes AS notes  FROM add_payment";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
// output data of each row
while($row = $result->fetch_assoc()) {
echo '<tr><td><a href="map.php?id=' . $row['id'] . '">تعديل</a></td>
<td>'.  $row['name'] . '</td>
<td>' . $row['notes'] . '</td>
<td>'.  $row['data'] . '</td>
<td>'.  $row['salary'] . '</td>
