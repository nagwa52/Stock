...
$sql = "SELECT Did AS Did,Ddate AS Ddate ,Dname AS Dname,Dsalary AS Dsalary,Ddata AS Ddata,Dnotes AS Dnotes  FROM delete_emp";
...
<td>' .$row['Dnotes'] .'</td>
<td>'. $row['Dname'] . '</td>
<td><a href="map.php?Did=' . $row['Did'] . '">تعديل</a></td></tr>';
